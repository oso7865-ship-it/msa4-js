...
let multi = num1 * num2;
console.log(multi);//50출력

let division = num1 / num2;
console.log(division);//0.5출력

let remainder = num1 % num2;
console.log(remainder);//5출력
// 문자열 연결
let str1 = 'a' + 'b';
...
//논리 연산자
//and 연산자: '&&'연결한 모든 조건이 true여야 true
//                 하나라도 false이면 false를 반환
console.log(1 === 1 && 1 >= 3); // false

// or 연산자 : '||'연결한 조건 중 하나라도 true면 true를 반환
//                  모든 조건이 false면 false를 반환
console.log(1 === 1 || 1 >= 3); // true

num = 1;
console.log((num === 1 || num >= 0) && typeof num === 'string'); //false
