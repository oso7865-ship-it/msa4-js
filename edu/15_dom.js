...
// Element.textContent: 컨텐츠를 흭득 및 변경
//  순수한 텍스트 데이터를 전달
const title1 = document.querySelector('#title');
title1.textContent; // 콘텐트 접근
title1.textContent = '테스트'; // 콘텐트 변경
// Element.innerHTML: 컨텐츠를 흭득 및 변경
//  태그는 태그로 인식해서 전달
...
title1.classList.remove('display-none'); // 클래스 추가
title1.classList.toggle('display-none'); // 클래스 토글(온 오프)
